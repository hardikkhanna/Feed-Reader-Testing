    ...
    */
    ...
    /* TODO: Write a new test suite named "The menu" */
        ...
        describe('Menu List',function(){
           it('Menu tag is hidden',function(){
             expect($('body').hasClass('menu-hidden')).toEqual(true);  
           });
            it('working menu on  click event',function()
              {
    ...
    describe('Initial Entries',function(){
         ...
         * the use of Jasmine's beforeEach and asynchronous cb() function.
         */
        ...
        it ('Feed Reader has one entry', function(cb) {
    ...
    describe('New Feed Selection', function() {
        ...
        it('oldFeed is not equal to newfeed', function() {
            expect(oldfeed).not.toEqual(newfeed); // old and new feed is not same
        });
    });
